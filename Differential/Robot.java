...
public class Robot {
    ...
    public double[] drive(Driver left, Driver right, double start, double end, double dt) {
        // integrate over deltas to get final state given variable left and right motor velocities
        double t = start;
    ...
    public double[] driveTo(
        ...
        // keep driving until the robot reaches within a certain tolerance of a target position
        double t = 0;
