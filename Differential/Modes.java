...
public class Modes {
    ...
    // TODO: state-based control modes (take into account robot state before making
    // corrections)

    public class Standard {
        /*
         * Standard controls first direct the robot to match the orientation of the
         * joystick,
    ...
    public class Curvature {
        ...
        public double[] set(double r, double theta, double[] state) {
            ...
            double[] velocities = robot.velocities(dir * omega, R);
